...
int main(int argc, char **argv)
{
    ...
    *sb = (struct fs7600_super){.magic = FS7600_MAGIC, .inode_map_sz = 1,
    ...
    root_de[6] = (struct fs7600_dirent){.valid = 1, .isDir = 0,
                                        .inode = f4_inode, .name = "file.7"};
    inodes[f4_inode] = (struct fs7600_inode){.uid = 1000, .gid = 1000, .mode = 0100777, 
    ...
    d1_de[6] = (struct fs7600_dirent){.valid = 1, .isDir = 0,
                                      .inode = f5_inode, .name = "file.270"};
    inodes[f5_inode] = (struct fs7600_inode){.uid = 1000, .gid = 1000, .mode = 0100777, 
                                             .ctime = t+300, .mtime = t+300,
                                             .size = 269*1024 + 721,
                                             .direct = {0, 0, 0, 0, 0, 0},
                                             .indir_1 = 0, .indir_2 = 0};
